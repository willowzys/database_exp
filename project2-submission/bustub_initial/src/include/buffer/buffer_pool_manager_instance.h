...
class BufferPoolManagerInstance : public BufferPoolManager {
 ...
 private:
  ...
  /**
   * @brief Helper function to evict a page from the given frame
   * @param frame_id the frame to evict
   */
  void EvictPage(frame_id_t frame_id);
  
  /**
   * @brief Helper function to reset page metadata
   * @param page the page to reset
   */
